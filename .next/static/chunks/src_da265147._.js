...
function AuthProviderContent({ children }) {
    _s();
    const { data: session, status, update: updateSession } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSession"])();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    const isLoading = status === "loading";
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProviderContent.useCallback[login]": async (email, passwordAttempt)=>{
            try {
                ...
                if (result?.ok && session?.user) {
                    toast({
                        ...
                        description: `Selamat datang kembali, ${session.user.name || session.user.email}!`
                    });
    ...
    }["AuthProviderContent.useCallback[login]"], [
        router,
        toast,
        session
    ]);
    const register = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProviderContent.useCallback[register]": async (email, passwordAttempt, fullName)=>{
            try {
                ...
                if (!response.ok) {
                    toast({
                        ...
                        description: data.error || "Tidak dapat mendaftar.",
                        variant: "destructive"
                    });
                    return false;
                }
    ...
    }["AuthProviderContent.useCallback[register]"], [
        router,
        toast
    ]);
    const logout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProviderContent.useCallback[logout]": async ()=>{
    ...
    }["AuthProviderContent.useCallback[logout]"], [
        router,
        toast
    ]);
    const updateUserProfile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProviderContent.useCallback[updateUserProfile]": async (data)=>{
            if (!session?.user?.id) {
                toast({
                    title: "Error",
                    description: "Anda harus login untuk memperbarui profil.",
                    variant: "destructive"
                });
                return false;
            }
            try {
                ...
                if (!response.ok) {
                    toast({
                        ...
                        description: result.error || "Tidak dapat memperbarui profil.",
                        variant: "destructive"
                    });
                    return false;
                }
                ...
                await updateSession({
                    ...
                    user: {
                        ...session.user,
                        ...result.user,
                        name: result.user.full_name || session.user.email
                    }
                });
                return true;
            } catch (error) {
    ...
    }["AuthProviderContent.useCallback[updateUserProfile]"], [
        session,
        toast,
        updateSession
    ]);
...
_s(AuthProviderContent, "bEtrCqwJopprhw0WpOZJBPaCEgk=", false, function() {
    return [
...
const AuthProvider = ({ children })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SessionProvider"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthProviderContent, {
            children: children
        }, void 0, false, {
            fileName: "[project]/src/hooks/use-auth.tsx",
            lineNumber: 169,
...
var _c, _c1;
__turbopack_context__.k.register(_c, "AuthProviderContent");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/constants.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$chevron$2d$down$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ChevronDown$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/chevron-down.js [app-client] (ecmascript) <export default as ChevronDown>"); // Added UserCog
...
//# sourceMappingURL=src_da265147._.js.map