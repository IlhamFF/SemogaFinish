...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabaseClient.ts [app-client] (ecmascript)"); // Import supabase client
;
...
const AuthProvider = ({ children })=>{
    ...
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // For custom loading like register
    const user = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
    ...
    const login = async (email, passwordAttempt)=>{
        ...
        try {
            ...
            // Success, session update will trigger redirection via useEffect in pages or AppLayout
            toast({
                title: "Login Berhasil",
                description: "Selamat datang kembali!"
            });
            // Redirection is handled by pages based on session status and role
            // Example: router.push(ROUTES.SISWA_DASHBOARD); // Or other appropriate dashboard
            setIsLoading(false);
            return true;
        } catch (error) {
    ...
    const register = async (email, passwordAttempt, name)=>{
        setIsLoading(true);
        try {
            ...
            if (!response.ok) {
                toast({
                    ...
                    description: data.message || "Tidak dapat membuat akun.",
                    variant: "destructive"
                });
                setIsLoading(false);
                return false;
            ...
            // After successful registration, NextAuth doesn't automatically sign in with Credentials.
            // Redirect to login or a page that informs about verification.
            router.push(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ROUTES"].VERIFY_EMAIL); // Or ROUTES.LOGIN if auto-login is not part of the flow
            setIsLoading(false);
            return true;
        } catch (error) {
    ...
    const sendVerificationEmail = async (email)=>{
        setIsLoading(true);
        // This is a Supabase specific call if you are using Supabase for auth email verification trigger.
        // If Auth.js handles it differently (e.g. VerificationToken provider), this needs adjustment.
        // For now, assuming Supabase client is available for resending.
        if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"]) {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.resend({
                type: 'signup',
                email: email
            });
            if (error) {
            ...
            toast({
                ...
                description: "Klien Supabase tidak dikonfigurasi.",
                variant: "destructive"
            });
        }
        setIsLoading(false);
    ...
    const handleSignOut = async ()=>{
        ...
        router.push(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ROUTES"].LOGIN); // Redirect to login page
        toast({
...
_s(AuthProvider, "m7DJWHZiozXE9VFNPnw4d6Whp2o=", false, function() {
    return [
...
function AppSidebarContent() {
    ...
    const finalLinks = user.role === 'superadmin' ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NAV_LINKS_CONFIG"].filter((link)=>link.roles.includes('superadmin') || link.roles.includes('admin')) // Show admin links too
     : uniqueLinks;
...
//# sourceMappingURL=src_4b7aba94._.js.map