...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$analytics$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/firebase/analytics/dist/index.mjs [app-ssr] (ecmascript) <module evaluation>"); // Import Analytics type
;
;
;
// Your web app's Firebase configuration
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyAmVwDkhWB_Z1zQTXCx3m-jN5F5ecI7eiw") || "AIzaSyAmVwDkhWB_Z1zQTXCx3m-jN5F5ecI7eiw",
    authDomain: ("TURBOPACK compile-time value", "bisadong-3ed0b.firebaseapp.com") || "bisadong-3ed0b.firebaseapp.com",
    projectId: ("TURBOPACK compile-time value", "bisadong-3ed0b") || "bisadong-3ed0b",
    storageBucket: ("TURBOPACK compile-time value", "bisadong-3ed0b.appspot.com") || "bisadong-3ed0b.appspot.com",
    messagingSenderId: ("TURBOPACK compile-time value", "503334203325") || "503334203325",
    appId: ("TURBOPACK compile-time value", "1:503334203325:web:fc3397f98bd954a0f96cd4") || "1:503334203325:web:fc3397f98bd954a0f96cd4",
    measurementId: ("TURBOPACK compile-time value", "G-5EVL481C1B") || "G-5EVL481C1B" // Optional
};
// Initialize Firebase
let app;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$219bb96f$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__a6__as__confirmPasswordReset$3e$__ = __turbopack_context__.i("[project]/node_modules/firebase/node_modules/@firebase/auth/dist/node-esm/totp-219bb96f.js [app-ssr] (ecmascript) <export a6 as confirmPasswordReset>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$219bb96f$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__am__as__updatePassword$3e$__ = __turbopack_context__.i("[project]/node_modules/firebase/node_modules/@firebase/auth/dist/node-esm/totp-219bb96f.js [app-ssr] (ecmascript) <export am as updatePassword>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/firebase.ts [app-ssr] (ecmascript)"); // Firebase auth instance
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-toast.ts [app-ssr] (ecmascript)");
...
const AuthProvider = ({ children })=>{
    ...
    const [appUser, setAppUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null); // Our application's user object
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useToast"])();
    const mapFirebaseUserToAppUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (fbUser)=>{
        if (!fbUser) return null;
        try {
            const response = await fetch(`/api/users/fb/${fbUser.uid}`); // Endpoint baru untuk get profile by Firebase UID
            if (response.ok) {
                const localProfileData = await response.json();
                return {
                    id: fbUser.uid,
                    email: fbUser.email || '',
                    ...
                    // Ambil data spesifik aplikasi dari profil lokal
                    role: localProfileData.role,
                    fullName: localProfileData.fullName || fbUser.displayName || fbUser.email?.split('@')[0],
                    phone: localProfileData.phone,
                    address: localProfileData.address,
                    birthDate: localProfileData.birthDate,
                    bio: localProfileData.bio,
                    nis: localProfileData.nis,
                    nip: localProfileData.nip,
                    joinDate: localProfileData.joinDate,
                    kelas: localProfileData.kelas,
                    mataPelajaran: localProfileData.mataPelajaran
                };
            } else {
                // Jika profil lokal tidak ditemukan (misalnya, pengguna baru saja mendaftar Firebase
                // dan profil lokal belum dibuat atau ada error saat sinkronisasi),
                // kembalikan data dasar dari Firebase.
                console.warn(`Local profile for Firebase UID ${fbUser.uid} not found. API status: ${response.status}`);
                return {
                    id: fbUser.uid,
                    email: fbUser.email || '',
                    name: fbUser.displayName,
    ...
    const updateSession = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        setIsLoading(true);
        const currentFbUser = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"].currentUser;
        if (currentFbUser) {
            await currentFbUser.reload(); // Reload Firebase user to get latest state (e.g., emailVerified)
            setFirebaseUser(currentFbUser);
            const newAppUser = await mapFirebaseUserToAppUser(currentFbUser);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$219bb96f$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__y__as__onAuthStateChanged$3e$__["onAuthStateChanged"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"], async (fbUser)=>{
            setIsLoading(true);
            if (fbUser) {
                await fbUser.reload(); // Selalu reload untuk mendapatkan status emailVerified terbaru
            }
            setFirebaseUser(fbUser);
            const currentAppUser = await mapFirebaseUserToAppUser(fbUser);
    ...
    const login = async (email, passwordAttempt)=>{
        setIsLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$219bb96f$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__ab__as__signInWithEmailAndPassword$3e$__["signInWithEmailAndPassword"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"], email, passwordAttempt);
            // onAuthStateChanged akan handle setting user dan mapping.
            // Jika mapFirebaseUserToAppUser tidak menemukan local profile, ia akan fallback.
            // Navigasi akan dihandle oleh halaman berdasarkan appUser.isVerified
            toast({
            ...
            if (error.code === 'auth/invalid-credential') {
                errorMessage = "Kredensial tidak valid. Periksa email dan kata sandi Anda.";
    ...
    const register = async (email, passwordAttempt)=>{
        setIsLoading(true);
        try {
            const userCredential = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$219bb96f$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__aa__as__createUserWithEmailAndPassword$3e$__["createUserWithEmailAndPassword"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"], email, passwordAttempt);
            const fbUser = userCredential.user;
            // Setelah pengguna Firebase dibuat, buat profil lokal di database Anda
            const localProfilePayload = {
                firebaseUid: fbUser.uid,
                email: fbUser.email,
                fullName: fbUser.email?.split('@')[0] || "Pengguna Baru",
                role: 'siswa',
                isVerified: false,
            ...
            if (!response.ok) {
                ...
                // Jika pembuatan profil lokal gagal, idealnya pengguna Firebase yang baru dibuat juga dihapus (rollback)
                // Untuk saat ini, kita hanya log dan toast error
                console.error("Gagal membuat profil lokal setelah registrasi Firebase:", errorData.message || "Unknown error");
                toast({
                    title: "Pendaftaran Gagal",
                    description: `Gagal menyimpan profil lokal: ${errorData.message || "Unknown error"}`,
                    variant: "destructive"
                });
                // Hapus pengguna Firebase jika profil lokal gagal dibuat? (Opsional, butuh hak admin)
                // await fbUser.delete();
                setIsLoading(false);
                return false;
            }
            // Lanjutkan dengan mengirim email verifikasi Firebase
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$219bb96f$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__ag__as__sendEmailVerification$3e$__["sendEmailVerification"])(fbUser);
            toast({
                title: "Pendaftaran Berhasil",
                description: "Silakan cek email Anda untuk verifikasi."
            });
            // onAuthStateChanged akan memuat appUser baru dengan data dari profil lokal (jika sukses)
            // dan halaman akan mengarahkan ke /verify-email
            setIsLoading(false);
            return true;
        } catch (error) {
    ...
    const logout = async ()=>{
        ...
        try {
            ...
            setAppUser(null);
            setFirebaseUser(null);
            router.push(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUTES"].LOGIN);
            toast({
    ...
    const sendVerificationEmail = async ()=>{
        if (firebaseUser) {
            setIsLoading(true);
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$219bb96f$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__ag__as__sendEmailVerification$3e$__["sendEmailVerification"])(firebaseUser);
                toast({
                    title: "Email Verifikasi Terkirim",
                    description: "Silakan cek kotak masuk Anda."
                });
            } catch (error) {
                toast({
            ...
            toast({
                title: "Error",
                description: "Tidak ada pengguna untuk mengirim email verifikasi.",
                variant: "destructive"
            });
        }
    };
    const updateUserProfile = async (profileData)=>{
        if (firebaseUser) {
            setIsLoading(true);
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$219bb96f$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__ak__as__updateProfile$3e$__["updateProfile"])(firebaseUser, profileData);
                await updateSession(); // Panggil updateSession untuk me-refresh appUser
                toast({
                    title: "Profil Firebase Diperbarui"
                });
                setIsLoading(false);
                return true;
            } catch (error) {
                toast({
                    title: "Gagal Memperbarui Profil Firebase",
                    description: error.message,
                    variant: "destructive"
                });
                setIsLoading(false);
    ...
    const requestPasswordReset = async (email)=>{
        setIsLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$219bb96f$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__a5__as__sendPasswordResetEmail$3e$__["sendPasswordResetEmail"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"], email);
            toast({
                title: "Email Reset Terkirim",
                description: "Jika email terdaftar, instruksi akan dikirim."
            });
            setIsLoading(false);
            return true;
        } catch (error) {
            toast({
                title: "Gagal Meminta Reset",
                description: error.message,
                variant: "destructive"
            });
            setIsLoading(false);
    ...
    const confirmPasswordReset = async (oobCode, newPassword)=>{
        setIsLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$219bb96f$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__a6__as__confirmPasswordReset$3e$__["confirmPasswordReset"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"], oobCode, newPassword);
            toast({
                title: "Kata Sandi Direset",
                description: "Anda sekarang dapat login dengan kata sandi baru."
            });
            router.push(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUTES"].LOGIN);
            setIsLoading(false);
            return true;
    ...
    const changePassword = async (newPassword)=>{
        if (firebaseUser) {
            setIsLoading(true);
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$219bb96f$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__am__as__updatePassword$3e$__["updatePassword"])(firebaseUser, newPassword);
                toast({
                ...
                if (error.code === 'auth/requires-recent-login') {
                    toast({
                        title: "Autentikasi Ulang Diperlukan",
                        description: "Silakan login kembali sebelum mengubah kata sandi.",
                        variant: "destructive"
                    });
                    await logout();
                } else {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-auth.tsx [app-ssr] (ecmascript)"); // Changed to our new Firebase AuthProvider
// SessionProvider from next-auth/react is no longer needed
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/constants.ts [app-ssr] (ecmascript)");
"use client";
;
;
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("head", {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("meta", {
                        name: "description",
                        content: "Sistem Manajemen Pendidikan Komprehensif untuk SMA Az-Bail"
                    }, void 0, false, {
                        fileName: "[project]/src/app/layout.tsx",
                        lineNumber: 19,
                        columnNumber: 9
...
//# sourceMappingURL=%5Broot-of-the-server%5D__472a5dfa._.js.map