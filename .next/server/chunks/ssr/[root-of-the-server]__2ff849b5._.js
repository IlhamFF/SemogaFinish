...
const AuthProvider = ({ children })=>{
    ...
    const deleteUser = (userId)=>{
        ...
        if (userToDelete) {
            delete mockPasswords[userToDelete.email];
        }
    ...
    const requestPasswordReset = async (email)=>{
        ...
        const existingUser = users.find((u)=>u.email === email);
        if (existingUser) {
            // Simulate sending reset link. In a real app, generate a token and send email.
            // For mock, we can just redirect to reset page with email in query (not secure for real app)
            router.push(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUTES"].RESET_PASSWORD}?email=${encodeURIComponent(email)}`);
            setIsLoading(false);
            return true;
        }
        setIsLoading(false);
    ...
    const resetPassword = async (email, newPassword)=>{
        ...
        if (existingUser) {
            ...
            // Note: Users array in localStorage does not store passwords, so no update needed there.
            // Passwords are only in the mockPasswords object in memory for this hook.
            setIsLoading(false);
            return true;
        }
        setIsLoading(false);
        ...
        if (!isLoading) {
            if (user) {
                if (user.role === 'siswa' && !user.isVerified) {
                    ...
                    switch(user.role){
                        case 'admin':
                            router.replace(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUTES"].ADMIN_DASHBOARD);
                            break;
                        case 'guru':
                            router.replace(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUTES"].GURU_DASHBOARD);
                            break;
                        case 'siswa':
                            router.replace(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUTES"].SISWA_DASHBOARD);
                            break;
                        case 'pimpinan':
                            router.replace(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUTES"].PIMPINAN_DASHBOARD);
                            break;
                        case 'superadmin':
                            router.replace(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUTES"].ADMIN_DASHBOARD);
                            break; // Superadmin can go to admin dash
                        default:
                            router.replace(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUTES"].LOGIN); // Fallback
                    }
                }
            } else {
...
function HomePage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthProvider"], {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2ff849b5._.js.map