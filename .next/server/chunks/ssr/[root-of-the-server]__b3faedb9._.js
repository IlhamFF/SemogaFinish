...
const AuthProvider = ({ children })=>{
    const { data: session, status, update } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSession"])();
    ...
    const login = async (email, passwordAttempt)=>{
        ...
        if (result?.error) {
            ...
            toast({
                title: "Login Gagal",
                description: result.error === "CredentialsSignin" ? "Email atau kata sandi salah." : result.error,
                variant: "destructive"
            });
            return false;
        }
    ...
    const logout = async ()=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signOut"])({
            redirect: true,
            callbackUrl: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUTES"].LOGIN
        });
        toast({
    ...
    const verifyUserEmail = async (userIdToVerify)=>{
    ...
    const updateUserProfile = async (userId, profileData)=>{
        ...
        toast({
            ...
            description: "Tidak dapat memperbarui profil pengguna ini.",
            variant: "destructive"
        });
        return false;
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b3faedb9._.js.map