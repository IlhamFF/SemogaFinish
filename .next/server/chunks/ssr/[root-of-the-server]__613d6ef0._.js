...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabaseClient.ts [app-ssr] (ecmascript)"); // Import supabase client
"use client";
;
;
;
...
const AuthProvider = ({ children })=>{
    ...
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false); // For custom loading like register
    const user = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useMemo(()=>{
        if (session?.user) {
            return {
                id: session.user.id,
    ...
    const register = async (email, passwordAttempt, name)=>{
        ...
        try {
            ...
            router.push(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUTES"].VERIFY_EMAIL); // Or ROUTES.LOGIN if auto-login is not part of the flow
            setIsLoading(false);
            return true;
        } catch (error) {
    ...
    const sendVerificationEmail = async (email)=>{
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"]) {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.resend({
                type: 'signup',
                email: email
            });
            if (error) {
    ...
    const handleSignOut = async ()=>{
        ...
        router.push(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUTES"].LOGIN); // Redirect to login page
        toast({
...
function AppSidebarContent() {
    ...
    const finalLinks = user.role === 'superadmin' ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NAV_LINKS_CONFIG"].filter((link)=>link.roles.includes('superadmin') || link.roles.includes('admin')) // Show admin links too
     : uniqueLinks;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__613d6ef0._.js.map