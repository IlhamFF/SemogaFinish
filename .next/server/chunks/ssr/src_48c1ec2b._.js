...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-toast.ts [app-ssr] (ecmascript)"); // Changed from useAuth
        ...
        try {
            ...
            if (!response.ok) {
                ...
                if (data.demoResetToken) {
                    router.push(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUTES"].RESET_PASSWORD}?email=${encodeURIComponent(values.email)}&token=${data.demoResetToken}`);
                }
            }
        } catch (error) {
            toast({
...
//# sourceMappingURL=src_48c1ec2b._.js.map