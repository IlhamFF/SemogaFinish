...
function LoginPageContent() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!isLoading && user && session) {
            ...
            if (user.role === 'siswa' && !user.isVerified) {
                // If Siswa and not verified, they shouldn't be able to login fully.
                // Supabase usually prevents login if email confirmation is required and not done.
                // If they somehow get here (e.g. direct navigation after registration without verification step),
            ...
            switch(user.role){
                ...
                case 'siswa':
                    ...
                    break; // Already checked for verification above
                case 'pimpinan':
                ...
                case 'superadmin':
                    ...
                    break;
                default:
                    router.replace(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUTES"].HOME); // Fallback, should ideally not happen
            }
        }
    // If not loading, and no user/session, they should see the login form.
    }, [
        user,
        isLoading,
        session,
    ...
    // Show loader while checking auth state, or if user is logged in and is being redirected.
    ...
    // If not loading, and no user/session, show the login form.
...
//# sourceMappingURL=%5Broot-of-the-server%5D__852bc910._.js.map