...
function AuthForm({ mode }) {
    const { login, register, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useToast"])();
    ...
    async function onSubmit(values) {
        ...
        if (mode === "login") {
            ...
            // Redirection is handled by LoginPage useEffect
            ...
            if (result.success && result.user) {
                ...
                // Redirection handled by RegisterPage useEffect
                }
            } else if (result.error) {
...
function RegisterPageContent() {
    const { user, isLoading, session } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // If user is already logged in (has a user object and session), redirect them.
        if (!isLoading && user && session) {
            if (user.role === 'siswa' && !user.isVerified) {
                // If a siswa registers and email verification is pending, they might be redirected
                // here by AuthForm, or if they navigate here while still unverified.
                ...
                // Redirect to appropriate dashboard if verified or not a siswa needing verification
                switch(user.role){
                    case 'admin':
                    ...
                    case 'superadmin':
                        ...
                        break;
                    default:
                        router.replace(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUTES"].HOME); // Fallback
                }
            }
        }
    // If user is loading, or no user/session, they will see the registration form or loader.
    }, [
        user,
        isLoading,
        session,
    ...
    // Show loader if checking auth state, or if user is logged in and will be redirected.
    ...
    // If not loading and no user/session, show registration form.
...
//# sourceMappingURL=%5Broot-of-the-server%5D__85323853._.js.map