...
"[project]/node_modules/typeorm/driver/sap/SapQueryRunner.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
const TransactionAlreadyStartedError_1 = __turbopack_context__.r("[project]/node_modules/typeorm/error/TransactionAlreadyStartedError.js [app-route] (ecmascript)");
 ...
 */ class SapQueryRunner extends BaseQueryRunner_1.BaseQueryRunner {
     ...
     */ async startTransaction(isolationLevel) {
        ...
        if (this.isTransactionActive && this.driver.transactionSupport === "simple") throw new TransactionAlreadyStartedError_1.TransactionAlreadyStartedError();
     ...
     */ async query(query, parameters, useStructuredResult = false) {
        ...
        try {
            ...
            let raw;
            try {
                raw = statement ? await (0, util_1.promisify)(statement.exec).call(statement, parameters) : await (0, util_1.promisify)(databaseConnection.exec).call(databaseConnection, query, parameters, {});
            } catch (err) {
            ...
            if (isInsertQuery) {
                ...
                const identityValueResult = await new Promise((ok, fail)=>{
                    databaseConnection.exec(lastIdQuery, (err, raw)=>err ? fail(new error_1.QueryFailedError(lastIdQuery, [], err)) : ok(raw));
                });
     ...
     */ async changeColumn(tableOrName, oldTableColumnOrName, newColumn) {
        ...
        if (newColumn.isGenerated !== oldColumn.isGenerated && newColumn.generationStrategy !== "uuid" || newColumn.type !== oldColumn.type || newColumn.length !== oldColumn.length) {
            ...
            if (this.isColumnChanged(oldColumn, newColumn, true)) {
                upQueries.push(new Query_1.Query(`ALTER TABLE ${this.escapePath(table)} ALTER (${this.buildCreateColumnSql(newColumn, !(oldColumn.default === null || oldColumn.default === undefined), !oldColumn.isNullable)})`));
                downQueries.push(new Query_1.Query(`ALTER TABLE ${this.escapePath(table)} ALTER (${this.buildCreateColumnSql(oldColumn, !(newColumn.default === null || newColumn.default === undefined), !newColumn.isNullable)})`));
     ...
     */ async loadTables(tableNames) {
        ...
        return Promise.all(dbTables.map(async (dbTable)=>{
            ...
            table.columns = await Promise.all(dbColumns.filter((dbColumn)=>dbColumn["TABLE_NAME"] === dbTable["TABLE_NAME"] && dbColumn["SCHEMA_NAME"] === dbTable["SCHEMA_NAME"]).map(async (dbColumn)=>{
            ...
            const tableCheckConstraints = OrmUtils_1.OrmUtils.uniq(dbConstraints.filter((dbConstraint)=>dbConstraint["TABLE_NAME"] === dbTable["TABLE_NAME"] && dbConstraint["SCHEMA_NAME"] === dbTable["SCHEMA_NAME"] && dbConstraint["CHECK_CONDITION"] !== null && dbConstraint["CHECK_CONDITION"] !== undefined), (dbConstraint)=>dbConstraint["CONSTRAINT_NAME"]);
...
exports.SapQueryRunner = SapQueryRunner; //# sourceMappingURL=SapQueryRunner.js.map
}}),
"[project]/node_modules/typeorm/driver/sap/SapDriver.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
const OrmUtils_1 = __turbopack_context__.r("[project]/node_modules/typeorm/util/OrmUtils.js [app-route] (ecmascript)");
const SapQueryRunner_1 = __turbopack_context__.r("[project]/node_modules/typeorm/driver/sap/SapQueryRunner.js [app-route] (ecmascript)");
 ...
 */ class SapDriver {
     ...
     */ escapeQueryWithParameters(sql, parameters, nativeParameters) {
        const escapedParameters = Object.keys(nativeParameters).map((key)=>{
            if (nativeParameters[key] instanceof Date) return DateUtils_1.DateUtils.mixedDateToDatetimeString(nativeParameters[key], true);
...
exports.SapDriver = SapDriver; //# sourceMappingURL=SapDriver.js.map
}}),

};

//# sourceMappingURL=node_modules_typeorm_driver_sap_d18f348c._.js.map