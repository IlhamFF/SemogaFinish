...
export class RppEntity {
  ...
  @ManyToOne("MataPelajaranEntity", (mapel: MataPelajaranEntity) => mapel.rppList, { onDelete: "CASCADE" })
  ...
  @ManyToOne("UserEntity", (user: UserEntity) => user.rppUploaded, { onDelete: "SET NULL", nullable: true })
