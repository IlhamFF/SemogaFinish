...
export class StrukturKurikulumEntity {
  ...
  @ManyToOne("MataPelajaranEntity", (mapel: MataPelajaranEntity) => mapel.strukturKurikulumEntries, { onDelete: "CASCADE" })
  ...
  @ManyToOne("UserEntity", (user: UserEntity) => user.strukturKurikulumDiajar, { onDelete: "SET NULL", nullable: true })
