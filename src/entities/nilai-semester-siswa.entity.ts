...
export class NilaiSemesterSiswaEntity {
  ...
  @ManyToOne("UserEntity", (user: UserEntity) => user.nilaiSemesterSiswa, { onDelete: "CASCADE" })
  ...
  @ManyToOne("MataPelajaranEntity", (mapel: MataPelajaranEntity) => mapel.nilaiSemesterSiswaEntries, { onDelete: "CASCADE" })
  ...
  @ManyToOne("UserEntity", (guru: UserEntity) => guru.nilaiDicatatOlehGuru, { onDelete: "SET NULL", nullable: true })
