...
export class SilabusEntity {
  ...
  @ManyToOne("MataPelajaranEntity", (mapel: MataPelajaranEntity) => mapel.silabusList, { onDelete: "CASCADE" })
  ...
  @ManyToOne("UserEntity", (user: UserEntity) => user.silabusUploaded, { onDelete: "SET NULL", nullable: true })
