...
const statCards = [
  { title: "Total Pengguna", value: "150", icon: Users, color: "text-primary", link: ROUTES.ADMIN_USERS },
  { title: "Kursus", value: "25", icon: BookOpenText, color: "text-green-500" },
  { title: "Verifikasi Tertunda", value: "5", icon: Users, color: "text-yellow-500", link: ROUTES.ADMIN_USERS },
  { title: "Peringatan Sistem", value: "2", icon: Bell, color: "text-red-500" },
];
...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-muted-foreground">Selamat datang, {user.name || user.email}! Kelola pengguna, pengaturan, dan lihat gambaran umum sistem.</p>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="shadow-lg">
          <CardHeader>
            ...
            <CardDescription>Gambaran umum kejadian sistem terkini.</CardDescription>
          </CardHeader>
          <CardContent>
