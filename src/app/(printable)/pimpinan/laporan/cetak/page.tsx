...
import { Loader2, Printer, Users, CheckCircle, BookOpenCheck } from "lucide-react";
...
export default function CetakLaporanPimpinanPage() {
  ...
  const pimpinanStats = useMemo(() => {
    return [
      ...
      { title: "Tingkat Kelulusan (Simulasi)", value: "95%", icon: CheckCircle },
    ];
  }, [akademikData]);
  ...
  return (
    <div className="bg-white text-black p-4 print:p-0 font-sans">
      <div className="max-w-4xl mx-auto A4-container bg-white p-8 print:p-2 print:shadow-none">
        ...
        <section className="my-8">
          <h2 className="text-xl font-semibold mb-4 border-b pb-2">Ringkasan Statistik Utama</h2>
        ...
        <section className="my-8">
            <h2 className="text-xl font-semibold mb-4 border-b pb-2">Peringkat 10 Siswa Terbaik (Keseluruhan)</h2>
            <Table>
                <TableHeader>
                    <TableRow>
                ...
                <TableBody>
                    ...
                    <TableRow key={siswa.nama}>
                        ...
                        <TableCell className="text-right font-medium">{(+siswa.rataRata).toFixed(2)}</TableCell>
                    </TableRow>
                    ))}
                </TableBody>
            </Table>
        ...
        <section className="my-8 break-inside-avoid">
            <h2 className="text-xl font-semibold mb-4 border-b pb-2">Rata-rata Nilai per Kelas</h2>
            <Table>
                <TableHeader>
                <TableRow>
                    <TableHead>Kelas</TableHead>
